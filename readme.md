...
# 👀 pdf 2 voice and Text

application that converts a PDF file to sound and also extracts the text

> You can try the app [here](https://sagi-Pdf2Voice.streamlit.app/)
...
2. Click on the "Extract voice and text" button
3. In moments, you will receive a ready-to-listen audio file and text of the entire document!
